...
public class Animation<E>
{
    ...
    {        
        /*Animation<String> scroll = developAnimation(StringAnimationType.SCROLL_BCK, "sh§4ort", 3, 100, 1);
        ...
        System.out.println();
        scroll = developAnimation(StringAnimationType.SCROLL_FWD, "§2hello §4world", 5, 100, 1);
        for(int i = 0; i < scroll.getNumFrames(); i++)
        {
            System.out.println(ChatColor.stripColor(scroll.getFrame(i)) + " | " + scroll.getFrame(i));
        }
        System.out.println();
        scroll = developAnimation(StringAnimationType.SCROLL_BCK, "§2hello §4world", 5, 100, 1);
        for(int i = 0; i < scroll.getNumFrames(); i++)
        {
            System.out.println(ChatColor.stripColor(scroll.getFrame(i)) + " | " + scroll.getFrame(i));
        }*/
        ...
        /*System.out.println();
        scroll = developAnimation(StringAnimationType.WRAP_SCROLL_BCK, "§2hello §4world", 5, 100, 1);
        for(int i = 0; i < scroll.getNumFrames(); i++)
        {
            System.out.println(ChatColor.stripColor(scroll.getFrame(i)) + " | " + scroll.getFrame(i));
        }
        /*System.out.println("\n\n");
        Animation<String> fwd = developAnimation(StringAnimationType.SCROLL_FWD, "this is a scroller foward test.", 15, 100, 1);
        for(int i = 0; i < fwd.getNumFrames(); i++)
        {
            System.out.println(fwd.getFrame(i));
        }
        System.out.println("\n\n");
        Animation<String> wrapped = developAnimation(StringAnimationType.WRAP_SCROLL_FWD, "this is a longer, wrapper forward test.", 15, 100, 2);
        for(int i = 0; i < wrapped.getNumFrames(); i++)
        {
            System.out.println(wrapped.getFrame(i));
        }
        System.out.println("\n\n");
        Animation<String> wrapBack = developAnimation(StringAnimationType.WRAP_SCROLL_BCK, "this is a longer, wrapper backward test.", 15, 100, 1);
        for(int i = 0; i < wrapBack.getNumFrames(); i++)
        {
            System.out.println(wrapBack.getFrame(i));
        }
        System.out.println("\n\n");
        Animation<String> none = developAnimation(StringAnimationType.NONE, "this is no animation :(.", 15, 100, 1);
        for(int i = 0; i < none.getNumFrames(); i++)
        {
            System.out.println(none.getFrame(i));
        }
        System.out.println("\n\n");
        Animation<String> frame = developAnimation(StringAnimationType.FRAME_BY_FRAME, "this;is a frame;by frame;animation.", 15, 100, 1);
        for(int i = 0; i < frame.getNumFrames(); i++)
        {
            System.out.println(frame.getFrame(i));
        }*/
    }
